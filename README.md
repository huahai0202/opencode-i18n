...
```text
请从 https://github.com/huahai0202/opencode-i18n 安装 OpenCode i18n 插件：克隆仓库，运行仓库里的 install.ps1 或按 README 手动复制文件到我的全局 OpenCode 配置目录，保留我已有配置并合并 tui.json 的 plugin 列表；完成后告诉我重启 OpenCode，并运行 /i18n 选择 English、简体中文或繁體中文。
```
